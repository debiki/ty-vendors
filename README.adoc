...
You might need to do some tweaks in ../Dockerfile — for example, bumping the
Alpine OS version.

To find out what to change, find OpenResty's Dockerfile for
...
Or, simpler: Clone https://github.com/openresty/docker-openresty, then,
sth like: `git diff 1.27.1.2-0 HEAD -- alpine/` to see what changed.
